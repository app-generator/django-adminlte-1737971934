...
- [Free Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-adminlte-1737971934) via `eMail` and `Discord`
...
```bash
$ git clone https://github.com/django-adminlte-1737971934.git
$ cd django-adminlte-1737971934
```
